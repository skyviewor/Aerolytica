...
async def record_instruction(instruction: str, scope: str = "project") -> dict:
    from aero.data.instructions import append_instruction
...
async def show_instructions(scope: str | None = None) -> dict:
    ...
    if scope:
        from aero.data.instructions import _resolve_scope_path
...
async def clear_instructions(scope: str = "project") -> dict:
    from aero.data.instructions import clear_instructions as _clear
