...
def launch_sub_agent(
    ...
    from aero.agent.subagent import launch_subagent_from_context
...
def query_sub_agents(task_id: str | None = None) -> dict:
    from aero.agent.subagent import query_subagents_from_context
...
def cancel_sub_agent(task_id: str) -> dict:
    from aero.agent.subagent import cancel_subagent_from_context
