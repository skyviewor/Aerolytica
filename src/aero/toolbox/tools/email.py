...
from aero.core.config import AeroConfig, save_email_smtp_password
...
def find_config() -> AeroConfig:
    ...
    config_path = project_dir / "aero.yaml"
...
def find_config_path() -> Path:
    return find_project_dir() / "aero.yaml"
...
@register_tool(
    ...
    parameters={
        ...
        "properties": {
            ...
            "from_name": {"type": "string", "description": "发件人显示名称，默认为 Aero"},
        },
...
async def send_email(
    ...
    display_name = from_name or email_cfg.from_name or "Aero"
    msg = MIMEMultipart()
