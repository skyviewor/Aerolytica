...
async def get_gfs_forecast_schedule(
    ...
    from aero.data.gfs_availability import gfs_forecast_hours_for_range
    from aero.adapters.gfs_adapter import normalize_cycle
...
async def download_gfs(
    ...
    from aero.data.gfs_availability import resolve_gfs_source
...
async def inspect_gfs_inventory(
    ...
    from aero.adapters.gfs_adapter import GFSAdapter, parse_gfs_idx, summarize_gfs_inventory
    from aero.data.gfs_availability import resolve_gfs_source
