...
async def search_cds_variables(keyword: str | None = None, data_type: str | None = None) -> dict:
    ...
    from aero.data.cds_variables import get_cds_variables
    from aero.data.cds_variables import search_cds_variables as _search
...
async def describe_cds_dataset(dataset_id: str | None = None) -> dict:
    ...
    from aero.data.cds_variables import describe_cds_dataset as _describe
...
async def lookup_ecmwf_parameter(
    ...
    from aero.data.ecmwf_params import lookup_ecmwf_parameters
...
async def search_gfs_variables(keyword: str | None = None) -> dict:
    ...
    from aero.data.gfs_params import get_gfs_parameters, search_gfs_parameters
    from aero.data.gfs_products import get_gfs_product_inventory, search_gfs_inventory
...
async def lookup_gfs_parameter(
    ...
    from aero.data.gfs_params import lookup_gfs_parameters
    from aero.data.gfs_products import get_gfs_product_inventory, search_gfs_inventory
