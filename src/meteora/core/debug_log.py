"""Background debug logging for Meteora.
...
def configure_debug_logging(
    *,
    ...
    env_enabled = os.environ.get("METEORA_DEBUG_LOG")
    if enabled is None:
        enabled = env_enabled != "0"

    env_path = os.environ.get("METEORA_DEBUG_LOG_PATH")
    log_path = Path(path or env_path or Path.home() / ".meteora" / "debug.log")
