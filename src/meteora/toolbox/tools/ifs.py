...
async def get_ifs_forecast_schedule(
    ...
    from meteora.adapters.ifs_adapter import ifs_forecast_segments, ifs_forecast_steps_for_range
...
async def download_ifs(
    ...
    from meteora.data.ifs_availability import resolve_ifs_source
    ...
    try:
        ...
        for step in steps:
            ...
            if decision.selected_source == "aws" and decision.requested_source == "auto":
                from meteora.agent.progress import emit_progress as _emit
...
async def search_ifs_variables(keyword: str | None = None) -> dict:
    from meteora.data.ifs_params import LEVTYPE_NAMES, search_ifs_parameters
