...
from meteora.toolbox.config_access import find_config
...
async def download_era5(
    ...
    from meteora.agent.progress import emit_progress, cancel_requested as _cancelled
    ...
    from meteora.adapters.cds_adapter import CDSAdapter
    ...
    if not cds_cfg.key:
        return {
            ...
            "message": (
                ...
                "进入 User Profile → API key，然后将 key 粘贴到 Meteora 对话框。\n"
...
async def check_era5_availability(
    ...
    from meteora.data.era5_availability import check_era5_source_availability
