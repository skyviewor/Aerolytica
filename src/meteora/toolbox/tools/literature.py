...
from meteora.toolbox.download_progress import download_progress_reporter, format_size
...
async def search_literature(
    ...
    from meteora.data.literature import search_works
...
async def save_literature(work_id: str, download_pdf: bool = False) -> dict:
    ...
    from meteora.data.literature import get_work_detail, save_metadata, update_index

    is_arxiv = work_id.startswith("arxiv:")
    if is_arxiv:
        from meteora.data.literature_pdf import download_pdf as _download_pdf
    else:
        from meteora.data.literature_pdf import download_pdf_candidates, resolve_pdf_urls
...
async def download_literature_pdf(
    ...
    from meteora.data.literature import load_saved_metadata, resolve_doi
    from meteora.data.literature_pdf import download_pdf as _download_pdf
    ...
    if paper_dir is None:
        from meteora.data.literature import save_metadata
...
async def list_literature() -> dict:
    ...
    from meteora.data.literature import list_saved
