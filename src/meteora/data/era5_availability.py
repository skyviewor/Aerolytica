...
from meteora.core.debug_log import debug_exception, debug_log
from meteora.data.era5_variable_map import resolve_cds_name
    ...
    try:
        ...
        if config_path is None:
            return ERA5SourceStatus(
                source="cds",
                available=False,
                reason="未找到 meteora.yaml 项目配置文件。",
                checked_at=_iso(now),
            )
